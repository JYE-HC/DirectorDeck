...
if TYPE_CHECKING:
    from directordeck_raylight.distributed_worker.parallel_group_manager import XFuserParallelContext
    from directordeck_raylight.distributed_worker.pipefusion_schema import PipeFusionConfig, StagePlan
