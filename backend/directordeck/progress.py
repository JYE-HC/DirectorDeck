...
_SAMPLER_CLASSES = frozenset(
    {"SamplerCustomAdvanced", "XFuserSamplerCustomAdvanced"}
)
...
def sampler_segment_for_node(
    ...
    """Resolve a sampler node only when it is one-to-one with child segments."""
...
class LivePreviewCache:
    ...
    def __init__(
        ...
        *,
        ...
        if ttl_seconds <= 0 or max_total_bytes < MAX_PREVIEW_MESSAGE_BYTES:
